              ...
              >
                ...
                >
                  ...
                  <div className="h-full overflow-y-auto scrollbar-hide px-8 sm:px-12 md:px-16 py-12">
                    ...
                    {/* Title */}
                    <motion.h2
                      className="text-4xl md:text-5xl font-bold text-center bg-gradient-to-r from-amber-800 via-amber-700 to-amber-800 bg-clip-text text-transparent mb-3 px-4"
